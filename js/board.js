function Board(){
  //view section;
	...
	var loadBalls = function(){
		var initPoints = [195,200,550,200,574,212,574,188,598,176,598,224,622,236,622,212,622,188,622,164,646,152,646,176,646,200,646,224,646,248,598,200];
	...
	var moveBalls = function(){
		for(var i=0;i<that.ballsArray.length;i++){
		  that.ballsArray[i].move();
			for(var j=0;j<that.ballsArray.length;j++){
				if(i!=j){
